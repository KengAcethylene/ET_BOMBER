...
public class InstuctionPage extends VBox implements HasButtonPage {
	...
	public InstuctionPage(StartPage startPage) {
		...
		backButton.setFont(Font.font("Time New Roman", 14));
	...
	private void createPage() {
		...
		headerLabel.setFont(Font.font("Time New Roman", 30));
		...
		aimOfGameHeader.setFont(Font.font("Time New Roman", 20));
		aimOfGameHeader.setBackground(bg);
		
		Label aimOfGameContentLabel = new Label(aimOfTheGameContentString);
		aimOfGameContentLabel.setFont(Font.font("Time New Roman", 14));
		...
		keyBoxHeader.setFont(Font.font("Time New Roman", 20));
		keyBoxHeader.setBackground(bg);
		
		Label keyContentLabel = new Label(keyString);
		keyContentLabel.setFont(Font.font("Time New Roman", 14));
		keyContentLabel.setWrapText(true);
		
		Label legendBoxHeader = new Label(" LEGEND ");
		legendBoxHeader.setFont(Font.font("Time New Roman", 20));
	...
	private GridPane createLegendBox() {
		...
		playeroneImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		playertwoImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		playerthreeImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		playerfourImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		minionImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		obstacleImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		bombUpgradeLabel.setFont(Font.font("Time New Roman", 14));
		...
		powerImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		speedImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		lifeImageLabel.setFont(Font.font("Time New Roman", 14));
		...
		shieldImageLabel.setFont(Font.font("Time New Roman", 14));
	...
	private ImageView createImageView(String imagePath) {
		String path = ClassLoader.getSystemResource(String.format("%s.png", imagePath)).toString();
